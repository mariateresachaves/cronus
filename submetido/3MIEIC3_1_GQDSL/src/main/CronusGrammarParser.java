...
*/
 ...
 /*@bgen(jjtree) Start */
        ...
        jjtn000.jjtSetFirstToken(getToken(1));Token v, eq, d, opar, comma, cpar, scol, n, osqbr, csqbr, i;
    try {
      label_1:
      while (true) {
        if (jj_2_1(3)) {
...
*/
 ...
 /*@bgen(jjtree) ListNodes */
        ...
        boolean jjtc000 = true;
        jjtree.openNodeScope(jjtn000);
        jjtn000.jjtSetFirstToken(getToken(1));Token eq, scol, v, d, n, o, c;
    try {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case NODE:
        NodeListDec();
...
*/
 ...
 /*@bgen(jjtree) NodeDegree */
        ...
        boolean jjtc000 = true;
        jjtree.openNodeScope(jjtn000);
        jjtn000.jjtSetFirstToken(getToken(1));Token degree, comp;
    try {
...
*/
 ...
 /*@bgen(jjtree) CompareValue */
        ASTCompareValue jjtn000 = new ASTCompareValue(JJTCOMPAREVALUE);
        boolean jjtc000 = true;
        jjtree.openNodeScope(jjtn000);
        jjtn000.jjtSetFirstToken(getToken(1));Token eq, os, s, i, f, cs, comma, comp, osqbr, csqbr;
    try {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case OSQBR:
      case CSQBR:
        ...
        switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
        case OSQBR:
            ASTOpenSquareBracket jjtn004 = new ASTOpenSquareBracket(JJTOPENSQUAREBRACKET);
            boolean jjtc004 = true;
            jjtree.openNodeScope(jjtn004);
            jjtn004.jjtSetFirstToken(getToken(1));
          try {
      ...
      case COMP:
        // Compares to a Value
                comp = jj_consume_token(COMP);
                          ASTCompares jjtn006 = new ASTCompares(JJTCOMPARES);
                          boolean jjtc006 = true;
                          jjtree.openNodeScope(jjtn006);
                          jjtn006.jjtSetFirstToken(getToken(1));
        try {
...
*/
 ...
 /*@bgen(jjtree) SearchGraph */
        ...
        boolean jjtc000 = true;
        jjtree.openNodeScope(jjtn000);
        jjtn000.jjtSetFirstToken(getToken(1));Token v, eq, d, opar, comma, cpar, scol, s;
    try {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case NODE:
        NodeListDec();
      ...
      d = jj_consume_token(DOT);
                          ASTDot jjtn004 = new ASTDot(JJTDOT);
                          boolean jjtc004 = true;
                          jjtree.openNodeScope(jjtn004);
                          jjtn004.jjtSetFirstToken(getToken(1));
      try {
      ...
      s = jj_consume_token(SEARCH);
                             ASTSearch jjtn005 = new ASTSearch(JJTSEARCH);
                             boolean jjtc005 = true;
                             jjtree.openNodeScope(jjtn005);
                             jjtn005.jjtSetFirstToken(getToken(1));
      try {
      ...
      SearchType();
      cpar = jj_consume_token(CPAR);
                           ASTCloseParenthesis jjtn006 = new ASTCloseParenthesis(JJTCLOSEPARENTHESIS);
                           boolean jjtc006 = true;
                           jjtree.openNodeScope(jjtn006);
                           jjtn006.jjtSetFirstToken(getToken(1));
      try {
      ...
      scol = jj_consume_token(SCOL);
                           ASTSemicolon jjtn007 = new ASTSemicolon(JJTSEMICOLON);
                           boolean jjtc007 = true;
                           jjtree.openNodeScope(jjtn007);
                           jjtn007.jjtSetFirstToken(getToken(1));
      try {
...
*/
 ...
 /*@bgen(jjtree) SearchType */
        ...
        boolean jjtc000 = true;
        jjtree.openNodeScope(jjtn000);
        jjtn000.jjtSetFirstToken(getToken(1));Token opar, v, comma;
    try {
      opar = jj_consume_token(OPAR);
                           ASTOpenParenthesis jjtn001 = new ASTOpenParenthesis(JJTOPENPARENTHESIS);
                           boolean jjtc001 = true;
                           jjtree.openNodeScope(jjtn001);
                           jjtn001.jjtSetFirstToken(getToken(1));
      try {
...
/*
	== MORE VARS ==
*/
  static final public void MoreVars() throws ParseException {
 /*@bgen(jjtree) MoreVars */
        ASTMoreVars jjtn000 = new ASTMoreVars(JJTMOREVARS);
        boolean jjtc000 = true;
        jjtree.openNodeScope(jjtn000);
        jjtn000.jjtSetFirstToken(getToken(1));Token v, comma, i, comp;
    try {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case VARIABLE:
        v = jj_consume_token(VARIABLE);
      ...
      case COMMA:
        ...
        comp = jj_consume_token(COMP);
                           ASTCompares jjtn005 = new ASTCompares(JJTCOMPARES);
                           boolean jjtc005 = true;
                           jjtree.openNodeScope(jjtn005);
                           jjtn005.jjtSetFirstToken(getToken(1));
        try {
        ...
        i = jj_consume_token(INTEGER);
                              ASTInteger jjtn006 = new ASTInteger(JJTINTEGER);
                              boolean jjtc006 = true;
                              jjtree.openNodeScope(jjtn006);
                              jjtn006.jjtSetFirstToken(getToken(1));
        try {
...
/*
	== GET NODE ==
*/
  static final public void GetNode() throws ParseException {
 /*@bgen(jjtree) GetNode */
        ASTGetNode jjtn000 = new ASTGetNode(JJTGETNODE);
        boolean jjtc000 = true;
        jjtree.openNodeScope(jjtn000);
        jjtn000.jjtSetFirstToken(getToken(1));Token n, v, eq, osqbr, i, csqbr, scol;
    try {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case NODE:
        n = jj_consume_token(NODE);
      ...
      csqbr = jj_consume_token(CSQBR);
                            ASTCloseSquareBracket jjtn007 = new ASTCloseSquareBracket(JJTCLOSESQUAREBRACKET);
                            boolean jjtc007 = true;
                            jjtree.openNodeScope(jjtn007);
                            jjtn007.jjtSetFirstToken(getToken(1));
      try {
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x1400000,0x1e00000,0xa00000,0x200000,0x0,0x1400000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x40000c00,0x40000c00,0x40000000,0x0,0x0,0xe000000,0x0,0x0,0x0,0x1400000,0x1000000,0x400000,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0x0,0x0,0x0,0x20,0x0,0x10,0x10,0x10,0x10,0x10,0x10,0x10,0x10,0x10,0x10,0x10,0x10,0x0,0x0,0x0,0x10,0x10,0x0,0x3,0x3,0x83,0x0,0x90,0x0,};
   }
